...
public class HotelManagementController {
    ...
    public String addHotel(@RequestBody Hotel hotel) {
        ...
        return hotelManagementService.addHotel(hotel) ? "SUCCESS" : "FAILURE";
    }
    ...
    public String getHotelWithMostFacilities() {
        ...
        return hotelManagementService.getHotelNameWithMostFacilities();
    }
    ...
    public int bookARoom(@RequestBody Booking booking) {
        ...
        return hotelManagementService.bookARoomAndGetPrice(booking);
    }
